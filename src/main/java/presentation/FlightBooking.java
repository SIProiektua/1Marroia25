	...
	private  FlightBooking() {
		...
		flightList.addListSelectionListener(new javax.swing.event.ListSelectionListener() {
            public void valueChanged(javax.swing.event.ListSelectionEvent e) {
                ...
                } // The event is activated twice: Before the value is changed, and after changed
		...
		bookFlight.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (error) {
					System.out.println("if de abajo:" + selectedConcreteFlight.toString());
					bookFlight.setText("Error: There were no seats available!");
				}else {
					System.out.println("Booked. #seat left: " +(num-1));
		...
		dCities.setModel(new DefaultComboBoxModel(new String[] {"Barcelona ", "Donostia", "Sevilla"}));
		dCities.setBounds(99, 9, 243, 16);
		contentPane.add(dCities);

		aCities = new JComboBox();
		aCities.setModel(new DefaultComboBoxModel(new String[] {"Bilbo", "Madrid"}));
