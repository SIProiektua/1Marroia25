...
public class SegurtasunKopia1 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					SegurtasunKopia1 frame = new SegurtasunKopia1();
		...
		lookforFlights.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				while (flights.hasNext()) {
					...
					System.out.println(flightInfo_c.toString());
					bookFlight.setEnabled(true);
